...
//         TextWhite
//         TextSmall
//         subtitle="Consectetur adipiscing elit, sed do eiusmod tempor dunt ulter labore et dolore  magna."
//       />
//     </div>
//   );
// }
...
function RatingCard({ subtitle, img, UserName }) {
  return (
    <div>
      <section>
        <div className="mx-auto max-w-screen-xl sm:px-6 lg:px-8 py-5">
          <blockquote>
            ...
            <Subtitle TextSmall TextWhite subtitle={subtitle} />
